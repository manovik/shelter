    ...
    return (
      ...
      <div className="container">
        <div className="donate__wrapper">
          <img className="donate__img" src="./images/content/donation-dog.png" alt="Puppy" />
          <div className="donate__box">
            <h3 className="donate__title">You can also make a donation</h3>
            <p className="donate__text">Name of the bank / Type of bank account</p>
            <a className="donate__card" href="https://www.patreon.com/" title="Press to open donation place" target="_blank" rel="noreferrer">
              ...
              <p className="donate__card-number">8380 2880 8028 8791 7435</p>
            </a>
            <p className="donate__small-text">Legal information and lorem ipsum dolor sit amet, consectetur adipiscing
